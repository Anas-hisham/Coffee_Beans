...
const RegisterPage = ()=>{
    ...
    const { register, loading, error } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$hooks$2f$useAuth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    // form states
    ...
    const handleRegister = async ()=>{
        ...
        try {
            ...
            if (res) {
                ...
                router.push("/verify-email?email=".concat(encodeURIComponent(email)));
            }
        } catch (err) {
...
_s(RegisterPage, "l9tRKNNaHU1+4zihMj0s0LmJjXk=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
...
//# sourceMappingURL=app_8d9bc956._.js.map