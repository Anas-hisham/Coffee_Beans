...
"[project]/app/(auth)/forget-password/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const ForgetPasswordPage = ()=>{
    ...
    const { sendResetCode, loading, error } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$hooks$2f$useAuth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    ...
    const handleReset = async ()=>{
        try {
            ...
            if (res) {
                ...
                router.push("/confirm-forget-password?email=".concat(encodeURIComponent(email)));
            }
        } catch (err) {
...
_s(ForgetPasswordPage, "dPqSigMMZVdT7c+gZeyxXWC2ODY=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
...
var _c;
__turbopack_context__.k.register(_c, "ForgetPasswordPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=app_9f215753._.js.map